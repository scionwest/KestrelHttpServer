...
namespace Microsoft.AspNetCore.Server.Kestrel.Performance
{
    public class NullParser<TRequestHandler> : IHttpParser<TRequestHandler> where TRequestHandler : struct, IHttpHeadersHandler, IHttpRequestLineHandler
    {
        ...
        public bool ParseHeaders(TRequestHandler handler, ReadOnlyBuffer<byte> buffer, out Position consumed, out Position examined, out int consumedBytes)
        {
        ...
        public bool ParseRequestLine(TRequestHandler handler, ReadOnlyBuffer<byte> buffer, out Position consumed, out Position examined)
        {
